...
void RenderTarget::Init(const int width, const int height)
{
	renderTexture_ = RenderTexture::Create();
	renderTexture_->InitAsColorTexture(width, height);
	renderDepthTexture_ = RenderTexture::Create();
	renderDepthTexture_->InitAsDepthTexture(width, height);
...
void RenderTarget::InitRenderPass()
{
...
void RenderTarget::BeginRenderToTexture()
{
